...
pro kludge_mrd_ascii, header, structyp, use_colnum,   $
    range, table, $
...
pro kludge_mrd_table, header, structyp, use_colnum,           $ 
...
function kludge_mrdfits, file, extension, header,      $
        structyp = structyp,                    $
    ...
    if type eq 0 then begin
        ...
        kludge_mrd_ascii, header, structyp, use_colnum,                              $
        ...
        kludge_mrd_table, header, structyp, use_colnum,                            $
