...
;       would do as well.
;
; This routine taken from the David Fanning Consulting web site:
; http://www.dfanning.com/tips/point_in_polygon.html
;
; Original authors were Bård Krane with vector modifications from
; William Connelly (wmc)
;
; G. Meurer 07/2004 - returns -1 if no points inside and index set
    ...
    ENDIF ELSE BEGIN 
       IF keyword_set(index) THEN ret = -1
    ENDELSE 
