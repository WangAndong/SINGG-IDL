...
;
;        Fixed syms 22, 23 to give real stars
;        (Gerhardt Meurer - JHU Apr, 2005, meurer@pha.jhu.edu)
;
;-
...
case number of
    ...
    22  : usersym, psize*[1.,.4,1.,.4,1.,.4,1.,.4,1.,.4,1.]*cos((360./10.*findgen(11)+90.)/!radeg),$
                   psize*[1.,.4,1.,.4,1.,.4,1.,.4,1.,.4,1.]*sin((360./10.*findgen(11)+90.)/!radeg)
                                ; five pointed star

    23  : usersym, psize*[1.,.4,1.,.4,1.,.4,1.,.4,1.,.4,1.]*cos((360./10.*findgen(11)+90.)/!radeg),$
                   psize*[1.,.4,1.,.4,1.,.4,1.,.4,1.,.4,1.]*sin((360./10.*findgen(11)+90.)/!radeg),/fill
                                ; five pointed star
