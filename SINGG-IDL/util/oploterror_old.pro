PRO  oploterror_old, x, y, xerr, yerr, NOHAT=hat, HATLENGTH=hln, ERRTHICK=eth, $
...
;      renamed oploterror_old.pro because new version does not handle 
;        colors the way I do        G. Meurer        Jan 2012
;-
