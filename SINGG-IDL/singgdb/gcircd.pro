PRO gcircd,u,ra1,dc1,ra2,dc2,dis                        
;+
; NAME:
;     GCIRC
; PURPOSE:
...
;      add U = 2 everything in degrees & rename G. Meurer  Fen 2004
;-
 ...
 IF (npar ne 6) and (npar ne 5) THEN BEGIN
   ...
   print,'   U = 2  ==> Everything in degrees'
   RETURN
 ENDIF
 ...
 CASE u OF
   ...
   2:  BEGIN
       ...
       END
   ELSE:  MESSAGE, $
      'U must be 0 for radians; 1 for hours, degrees, arcsec; 2 for degrees'
 ENDCASE
