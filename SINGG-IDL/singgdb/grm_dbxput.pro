pro grm_dbxput,val,entry,idltype,sbyte,nbytes
;+
; NAME:
;	DBXPUT
; PURPOSE:
...
case idltype of		;case of data type
   ...
   7: begin			;string
	...
	val = strmid(val,0,nbytes)                   ;Truncate string
	;temp = replicate( 32b, nbytes, numvals, nentry)	    ;Array of blanks
	temp = replicate( 32b, nbytes, nentry)	    ;Array of blanks
	;for i = 0l, numvals-1l do temp[0,i,0] = byte(val[i,*])     ;Fill with values
