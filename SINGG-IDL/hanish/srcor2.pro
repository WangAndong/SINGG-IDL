PRO srcor2,x1in,y1in,x2in,y2in,dcr,ind1,ind2,$
   option=option,magnitude=magnitude,spherical=spherical,silent=silent
;+
; NAME:
;       SRCOR2
; PURPOSE:
...
; CALLING SEQUENCE:
;       srcor2,x1in,ylin,x2in,y2in,dcr,ind1,ind2
; INPUTS:
...
;       Added /SILENT keyword  D. Hanish 2005ish
;-
;
...
IF (n_params(0) lt 7) THEN BEGIN
  print,'SRCOR2 calling sequence: '
  print,'srcor2,x1in,y1in,x2in,y2in,dcr,ind1,ind2 [,option={0, 1, or 2}] $'
