pro ssoup_psp_indices, ll, nam, rad, sm, esm, flag, eflag, lflag, uflag, $
                       rmax, irmax, ij, ik, il, im, nij, nik, nil, nim
  ;
  ; Detemine which indices of a surface brightness profile should
  ...
  ;  ij    <- indices where sm is plottable (good or at a limit)
  ;  ik    <- indices where sm is good
  ;  il    <- indices where sm is at a lower limit
  ;  im    <- indices where sm is at an uppet limit
